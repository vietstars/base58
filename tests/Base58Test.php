...
class Base58Test extends TestCase
{
    ...
    public function testShouldUseBitcoinCharacterSet()
    {
        ...
        $php = new PhpEncoder(["characters" => Base58::CRYPTO]);
        $gmp = new GmpEncoder(["characters" => Base58::CRYPTO]);
        $bcmath = new BcmathEncoder(["characters" => Base58::CRYPTO]);
        $base58 = new Base58(["characters" => Base58::CRYPTO]);
    ...
    public function characterSetProvider()
    {
        return [
            ...
            "Bitcoin character set" => [Base58::CRYPTO],
